  ...
  return (
    <div className="flex flex-col sm:flex-row items-start justify-center gap-5 mx-5 sm:mx-10 mt-5">
      <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <a href="#">
          <h5 className="mb-2 text-lg sm:text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">
            Unbiased evaluation
          </h5>
        </a>
        <p className="mb-3 text-sm sm:text-base font-normal text-gray-500 dark:text-gray-400">
          AI ensures consistent, unbiased evaluations, reducing human error and
          bias.
        </p>
        <a
          href="#"
      ...
      <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <p className="mb-3 text-sm sm:text-base font-normal text-gray-500 dark:text-gray-400">
          Conversational AI can probe deeper with follow-ups to the participant
          responses.
        </p>
        <a
          href="#"
      ...
      <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <p className="mb-3 text-sm sm:text-base font-normal text-gray-500 dark:text-gray-400">
          AI-driven usability tests empower researchers and designers to gather
          insights for better user experiences
        </p>
        <a
          href="#"
          className="inline-flex font-medium items-center text-blue-600 hover:underline text-sm"
